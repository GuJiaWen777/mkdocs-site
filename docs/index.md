<div class="home-hero">
  <img src="images/gjw.jpg" alt="Profile Photo" class="profile-photo">
  
  <div class="profile-info">
    <h1>Jiawen Gu (顾嘉汶)</h1>
    <p class="subtitle">M.S. Student in Computer Science</p>
    <p>Shanghai Normal University</p>
    
    <!-- <div class="contact-links">
      <a href="mailto:your.email@example.com"><span class="twemoji">{% raw %}{% include ".icons/fontawesome/solid/envelope.svg" %}{% endraw %}</span> Email</a>
      <a href="https://github.com/gujiawen777"><span class="twemoji">{% raw %}{% include ".icons/fontawesome/brands/github.svg" %}{% endraw %}</span> GitHub</a>
      <a href="https://scholar.google.com/"><span class="twemoji">{% raw %}{% include ".icons/fontawesome/solid/graduation-cap.svg" %}{% endraw %}</span> Google Scholar</a>
    </div> -->
  </div>
</div>
